...
use App\Services\Platforms\DeezerPlatform;
use App\Services\Platforms\ItunesPlatform;
use App\Services\Platforms\LastFMPlatform;
use App\Services\Platforms\MixcloudPlatform;
use App\Services\Platforms\NapsterPlatform;
use App\Services\Platforms\QobuzPlatform;
use App\Services\Platforms\SoundcloudPlatform;
use App\Services\Platforms\SpotifyPlatform;
use App\Services\Platforms\TidalPlatform;
...
final class ApiCest
{
    ...
    public const TRACK_AGGREGATE_QUERY = 'radiohead+thinking+about+you';
    ...
    public const PERMALINKS = [
            ...
            'https://tidal.com/track/1669822' => [
                'musical_entity' => [
                    ...
                    'album' => [
                        'title' => 'Like a Prayer',
                        'artist' => 'Madonna',
                        'picture' => 'https://resources.wimpmusic.com/images/4c8f70ce/ab37/4cee/8839/cb59fd953b8b/320x320.jpg',
                        'safe_title' => 'Like a Prayer',
                        'extra_info' => [
                            'is_cover' => false,
                            'is_remix' => false,
                            'acoustic' => false,
                    ...
                    'links' => [
                        'tidal' => [
                            'http://www.tidal.com/track/1669822',
                        ],
                    ],
                    'safe_title' => 'Like a Prayer',
                    'extra_info' => [
        ...
        // Not testing youtube because of quotas
        // 'youtube' => [
    ...
    {
        $platforms = [
            DeezerPlatform::TAG => new DeezerPlatform('test', 'secret'),
            SpotifyPlatform::TAG => new SpotifyPlatform('test', 'secret'),
            QobuzPlatform::TAG => new QobuzPlatform('test', 'secret'),
            LastFMPlatform::TAG => new LastFMPlatform('test', 'secret'),
            SoundcloudPlatform::TAG => new SoundcloudPlatform('test', 'secret'),
            YoutubePlatform::TAG => new YoutubePlatform('test', 'secret'),
            MixcloudPlatform::TAG => new MixcloudPlatform('test', 'secret'),
            ItunesPlatform::TAG => new ItunesPlatform('test', 'secret'),
            TidalPlatform::TAG => new TidalPlatform('test', 'secret'),
            NapsterPlatform::TAG => new NapsterPlatform('test', 'secret'),
        ];
    ...
    public function _before(ApiTester $I)
    {
        ...
        $response = $I->sendPostAsJson('/auth/token', [
            'grant_type' => 'client_credentials',
            'client_id' => $_ENV['TEST_API_CLIENT_ID'],
            'client_secret' => $_ENV['TEST_API_CLIENT_SECRET'],
        ]);
    ...
    public function testLookupPermalink(ApiTester $I)
    {
        ...
        foreach (self::PERMALINKS as $platformTag => $permalinks) {
            $platform = $platforms[$platformTag];
            ...
            foreach ($permalinks as $permalink => $expectedResult) {
                ...
                $I->log(' →  ✅ '.$platform->getName().': '.$permalink);
            }
        }
    }
    ...
    {
        $platform = new SpotifyPlatform('test', 'secret');
