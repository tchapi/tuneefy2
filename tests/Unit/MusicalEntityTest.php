...
use App\Dataclass\MusicalEntity\MusicalEntityMergeException;
use Tests\Support\UnitTester;

final class MusicalEntityTest extends \Codeception\Test\Unit
{
    ...
    {
        $album_entity = new Album('test album (extra album)');
        $entity = new Track($album_entity, 'test title (extra)');
    ...
    {
        $entity = new Album('test title (extra)');
    ...
    {
        $a = new Album('test title a (extra)');
        $b = new Album('test title b (extra)');
    ...
    {
        $a_album = new Album('test title a album (extra)');
        $a = new Track($a_album, 'test title a (extra)');
        $b_album = new Album('test title b album (extra)');
        $b = new Track($b_album, 'test title b (extra)');
    ...
    {
        $a_album = new Album('test title a album (extra)');
        $a = new Track($a_album, 'test title a (acoustic)');
        $b_album = new Album('test title b album (extra)');
        $b = new Track($b_album, 'test title b (extra)');

        $this->expectException(MusicalEntityMergeException::class);
        $c = Track::merge($a, $b);
    }
    ...
    {
        $a_album = new Album('test title a album (extra)');
        $a = new Track($a_album, 'test title a');
        $b_album = new Album('test title b album (extra)');
        $b = new Track($b_album, 'test title b (cover)');
    ...
    {
        $a_album = new Album('test title a album (cover)');
        $a = new Track($a_album, 'test title a (acoustic)');
        $b_album = new Album('test title b album (extra)');
        $b = new Track($b_album, 'test title b (extra)');
    ...
    {
        $a_album = new Album('test title a album (remix)');
        $a = new Track($a_album, 'test title a (extra)');
        $b_album = new Album('test title b album (extra)');
        $b = new Track($b_album, 'test title b (remix)');
    ...
    {
        $a_album = new Album(' The Test Album');
        $a = new Track($a_album, 'My song (Explicit)');
        $b_album = new Album('the test album');
        $b = new Track($b_album, 'my song');
    ...
    public function testNonMatchingHash()
    {
        $a_album = new Album(' The Test Album');
        $a = new Track($a_album, 'My song (Explicit)');
        $b_album = new Album('my song');
        $b = new Track($b_album, 'the test album');
