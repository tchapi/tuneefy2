...
class OAuthRequest
{
  ...
  public $base_string = '';
    ...
    public function __construct(string $http_method, string $http_url, array $parameters = [])
    {
   ...
   */
  public static function from_consumer_and_token(OAuthConsumer $consumer, OAuthToken $token = null, string $http_method, string $http_url, array $parameters = []): OAuthRequest
  {
      $parameters = !is_null($parameters) ? $parameters : [];
  ...
  public function to_header(string $realm = null): string
  {
    ...
    public function build_signature(OAuthSignatureMethod $signature_method, OAuthConsumer $consumer, OAuthToken $token = null): string
    {
