...
{
    #[Route('/', name: 'home')]
    public function home(StatsService $statsService, PlatformEngine $engine, Request $request): Response
    {
    ...
    public function trends(StatsService $statsService, PlatformEngine $engine): Response
    {
    ...
    public function show(StatsService $statsService, ItemRepository $itemRepository, Request $request, string $uid, ?string $type = null): Response
    {
    ...
    public function listen(StatsService $statsService, ItemRepository $itemRepository, string $type, string $uid, string $platform, int $i = 0): Response
    {
