...
namespace App\Dataclass\MusicalEntity\Entities;

use App\Dataclass\MusicalEntity\MusicalEntity;
use App\Dataclass\MusicalEntity\MusicalEntityInterface;
use App\Dataclass\MusicalEntity\MusicalEntityMergeException;
use App\Utils\Utils;

class Track extends MusicalEntity
{
    ...
    public function __construct(Album $album, string $track_title = '')
    {
        parent::__construct();
    ...
    */
    ...
    public function setSafeTitle(string $safe_title): Track
    {
        $this->safe_track_title = $safe_title;
    ...
    public static function merge(Track $a, Track $b, bool $force = false): Track
    {
        ...
        $album = Album::merge($a->getAlbum(), $b->getAlbum(), true);
