...
class Album extends MusicalEntity
{
    ...
    */
    ...
    public function setSafeTitle(string $safe_title): Album
    {
        $this->safe_title = $safe_title;
    ...
    public static function merge(Album $a, Album $b, bool $force = false): Album
    {
